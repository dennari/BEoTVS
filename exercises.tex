...
into $500$ equidistant points. In figure \ref{fig:ex_3_2_variances}
the variances of the approximated Gaussian distributions are plotted for 
the Kalman filter and the grid approximation. As can be seen, thThe m-code is presented in listing \ref{lst:3_2}. 
...
mean of the grid approximation (green) in exercise~\ref{sec:3_2}}
\clearpage
\lstinputlisting[linerange=7-69,caption={m-code in exercise~\ref{sec:3_2}},label=lst:3_2]{ex3_2.m}
...
\lstinputlisting[linerange=189-227,caption={m-code in exercise~\ref{sec:4_3a}},label=lst:4_3a]{angle_ex.m}
...
\lstinputlisting[linerange=98-133,caption={m-code in exercise~\ref{sec:5_1}},label=lst:5_1]{ex4_1.m}
...
\clearpage
\lstinputlisting[linerange=148-214,caption={m-code in exercise~\ref{sec:5_2}},label=lst:5_2]{ex4_1.m}
...
\lstinputlisting[linerange=231-320,caption={m-code in exercise~\ref{sec:5_3}},label=lst:5_3]{angle_ex.m}
...
\placefig[htb]{ex_6_2}{1.0}{The true signal and the Bootstrap and SIR approximations
in exercise~\ref{sec:6_2}}

\clearpage

\lstinputlisting[linerange=229-327,caption={m-code in exercise~\ref{sec:6_2}},label=lst:6_2]{ex4_1.m}
...
\lstinputlisting[linerange=322-416,caption={m-code in exercise~\ref{sec:6_3}},label=lst:6_3]{angle_ex.m}
...
\placefig[htb]{ex_7_1a_means}{1.0}{The measurements, the true signal, the Kalman filter solution mean and the RTS smoother
solution mean in exercise~\ref{sec:7_1a}}
\placefig[htb]{ex_7_1a_variances}{1.0}{The Kalman filter solution's and the RTS smoother
solution's variances in exercise~\ref{sec:7_1a}}
\clearpage

\lstinputlisting[linerange=115-132,caption={m-code in exercise~\ref{sec:7_1a}},label=lst:7_1a]{ex3_2.m}
...
\placefig[htbp]{ex_7_1b_means}{1.0}{The RTS smoother's and its grid approximation's means in exercise~\ref{sec:7_1b}}
\placefig[htbp]{ex_7_1b_variances}{1.0}{The RTS smoother's and its grid approximation's variances in exercise~\ref{sec:7_1b}}

\clearpage
\lstinputlisting[linerange=161-185,caption={m-code in exercise~\ref{sec:7_1b}},label=lst:7_1b]{ex3_2.m}
...
\begin{table}[h]
	\centering
	\topcaption{The RMSE values in exercise \ref{sec:7_1c}}
	\input{ex_7_1_rmse}
	\label{table:rmse7_1}
\end{table}

\placefig[htb]{ex_7_1c_means}{1.0}{The RTS and the stationary RTS smoother's means in exercise~\ref{sec:7_1c}}
\placefig[htb]{ex_7_1c_variances}{1.0}{The RTS and the stationary RTS smoother's variances in exercise~\ref{sec:7_1c}}
\clearpage
\lstinputlisting[linerange=212-226,caption={m-code in exercise~\ref{sec:7_1c}},label=lst:7_1c]{ex3_2.m}
...
\begin{table}[h]
	\centering
	\topcaption{The RMSE values in exercise \ref{sec:7_2}}
	\input{ex_7_2_rmse}
	\label{table:rmse7_2}
\end{table}

\placefig[htb]{ex_7_2}{1.0}{The Kalman filter's and RTS smoother's means in exercise~\ref{sec:7_2}}
\lstinputlisting[linerange=178-208,caption={m-code in exercise~\ref{sec:7_2}},label=lst:7_2]{kf_ex.m}
...
\begin{table}[htb]
	\centering
	\topcaption{The RMSE values in exercise \ref{sec:7_3b}}
	\input{ex_7_3b_rmse}
	\label{table:rmse7_3b}
\end{table}


\placefig[htb]{ex_7_3b}{1.0}{The RTS smoothers for the EKF (ERTS) and SLF (SLRTS) filters in exercise~\ref{sec:7_3b}}
\clearpage
\lstinputlisting[linerange=346-397,caption={m-code in exercise~\ref{sec:7_3b}},label=lst:7_3b]{ex4_1.m}
