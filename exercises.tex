...
\begin{align}
	...
	&=e^{k\v{F}\Delta t}\v{x}(t_0)+\sum_{j=1}^k (-\v{F}^{-1})\left(\v{I}-e^{\v{F}\Delta t}\right)\v{L}w(t_{j-1})\\
	&=e^{k\v{F}\Delta t}\v{x}(t_0)+\v{F}^{-1}(e^{\v{F}\Delta t}-\v{I})\v{L}\sum_{j=1}^k w(t_{j-1})\\
	...
	&=e^{\v{F}\Delta t}\v{x}(t_{k-1})+\v{F}^{-1}(e^{\v{F}\Delta t}-\v{I})\v{L} w(t_{k-1})\\
...
\begin{figure}[htb]
  \begin{adjustwidth}{-2in}{-2in}
	  \centering
	  \subfloat[EKF approximation]{\label{fig:ex_5_3_ekf}\includegraphics[width=0.7\textwidth]{ex_4_3_ekf}}                
	  \subfloat[CKF/UKF approximation]{\label{fig:ex_5_3_ckfukf}\includegraphics[width=0.7\textwidth]{ex_5_3_ckfukf}}
  \end{adjustwidth}
