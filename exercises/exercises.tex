...
mean of the grid approximation (green) in exercise~\ref{sec:3_2}}
\placefig[p]{ex_3_2_bode}{1.0}{The frequency response of the LTI filter
described by the static Kalman filter in exercise~\ref{sec:3_2}}
\clearpage
\lstinputlisting[linerange=7-115,caption={m-code in exercise~\ref{sec:3_2}},label=lst:3_2]{ex3_2.m}
...
\lstinputlisting[linerange=117-137,caption={m-code in exercise~\ref{sec:7_1a}},label=lst:7_1a]{ex3_2.m}
...
\clearpage
\lstinputlisting[linerange=163-189,caption={m-code in exercise~\ref{sec:7_1b}},label=lst:7_1b]{ex3_2.m}
...
\clearpage
\lstinputlisting[linerange=216-228,caption={m-code in exercise~\ref{sec:7_1c}},label=lst:7_1c]{ex3_2.m}
